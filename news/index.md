...
- Vignette `Instructions about R packages`: add argument
  `build_vignettes` and update to version 3.23 in example code of
...
- Updated vignettes: some corrections in text. Changed order of some
  sections to be more logical. Explain notation for text to be filled in
