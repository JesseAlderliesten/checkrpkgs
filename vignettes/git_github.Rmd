...
are called 'remote files'. In addition, a folder on your PC (e.g.,
...
`C:\Program Files\Git\bin\git.exe` or (in the hidden folder) at
...
folder on your PC, then let `git` know it is there by typing (it is convenient
