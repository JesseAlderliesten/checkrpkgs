...
- in the [shell](https://happygitwithr.com/shell): to compare the content of two
  files, see the instructions in section 'Comparing files' below. Next, use
...
the documentation of [Git SCM](https://git-scm.com/docs), the
[section](https://happygitwithr.com/shell#basic-shell-commands) from 
