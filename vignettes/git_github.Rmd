...
file paths. For example, `<username>` and `<repositoryname>` are used as place
holders to refer to a username and repository name: `<username>` and
`<repositoryname>` in `https://github.com/<username>/<repositoryname>` should be
...
- in the [shell](https://happygitwithr.com/shell): to compare the content of two
  ...
  `git push https://github.com/<username>/<repositoryname>` to commit changes.
...
- To be able to push your changes back to a GitHub repository to which you
  **do** have writing access (e.g., to work on your project from another PC; or
  ...
  the repository URL (`https://github.com/<username>/<reposname>`) in the
  ...
  `git clone https://github.com/<username>/<reposname>` or with only the last
  commit by using `git clone --depth=1 https://github.com/<username>/<reposname>`.
...
- GitHub help pages:
  ...
  [setting up GitHub](https://docs.github.com/en/get-started/onboarding/getting-started-with-your-github-account), [general](https://docs.github.com/en) help, and
