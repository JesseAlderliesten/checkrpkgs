...
This vignette provides information on setting up and using Git (a version
control system) and [GitHub](https://github.com/) (a website where files,
usually code, can be stored). Git and GitHub are frequently used together.
...
To work with GitHub in RStudio, you should not open the R **script** (i.e., a
file with extension `.R`) but the R **Project file** (i.e., a file with extension
...
'R packages > Installing packages > Github' in the vignette *R packages*:
