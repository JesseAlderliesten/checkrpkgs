...
that, find the file in the local directory and delete the it. Then `pull`.
...
- To download code without being able to push your changes back to a GitHub
  ...
  package to a location of your R libraries (given by the output of
...
## GitHub Actions
See the section `Use GitHub Actions` in the vignette *Package setup* from
package `develcoder`: `vignette("pkg_setup", package = "develcoder")`.
