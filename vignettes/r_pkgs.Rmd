...
documentation. You have to install a package (see the section
[Installing packages]
...
[Getting the source code] below), and the installation pages of packages on CRAN frequently contain
...
internal functions without the need to specify
